...
(function(h) {
  ...
  function ra(a, b, c) {
    ...
    n = {
      ...
      error: function(b, c) {
        ...
        -1 === h.inArray(!0, d) &&
          ("parsererror" == c ? L(a, 0, "Invalid JSON response", 1) : 4 === b.readyState && L(a, 0, "Ajax error", 7));
        C(a, !1);
      }
    };
    a.oAjaxData = b;
  ...
  function pb(a) {
    var b = a.oClasses,
      ...
      f = function() {
        ...
        b != e.sSearch &&
          (fa(a, { sSearch: b, bRegex: e.bRegex, bSmart: e.bSmart, bCaseInsensitive: e.bCaseInsensitive }), (a._iDisplayStart = 0), O(a));
      },
    ...
    if ("ssp" != y(a) && 0 !== h.length) {
      ...
      g === h.length
        ...
        : i.sort(function(a, b) {
            ...
            for (j = 0; j < k; j++)
              if (
                ((i = h[j]), (c = m[i.col]), (g = p[i.col]), (i = e[i.type + "-" + i.dir] || e["string-" + i.dir]), (c = i(c, g)), 0 !== c)
              )
                return c;
            c = d[a];
            g = d[b];
  ...
  h.extend(r.prototype, {
    ...
    iterator: function(a, b, c, d) {
      ...
      return e.length || d
        ? ((a = new r(l, a ? e.concat.apply([], e) : e)), (b = a.selector), (b.rows = p.rows), (b.cols = p.cols), (b.opts = p.opts), a)
        : this;
    },
    lastIndexOf:
      w.lastIndexOf ||
