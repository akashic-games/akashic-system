    ...
    (b.EventEmitter = (function() {
      ...
      return (
        ...
        (a.prototype.fire = function() {
          var a, b, c, d, f, g, h;
          if (
            ((c = arguments[0]), (a = 2 <= arguments.length ? e.call(arguments, 1) : []), null != this.handlers && null != this.handlers[c])
          ) {
                      ...
                      (i.y = function() {
                        ...
                        for (c = this.options.ykeys, d = [], e = a = 0, b = c.length; b > a; e = ++a)
                          (n = c[e]),
                            ...
                            null != q &&
                              (this.cumulative ? (l += q) : null != o ? ((o = Math.max(q, o)), (p = Math.min(q, p))) : (o = p = q)),
    ...
    (b.Line = (function(a) {
      ...
      return (
        ...
        (c.prototype.hoverContentForRow = function(a) {
          var b, c, d, e, f, g, h;
          for (
            d = this.data[a], b = "<div class='morris-hover-row-label'>" + d.label + "</div>", h = d.y, c = f = 0, g = h.length;
            g > f;
            c = ++f
          )
            (e = h[c]),
              ...
              a = function(a, b) {
                ...
                return (
                  ...
                  0 !== l.options.xLabelAngle &&
                    ((i = -0.5 * j.width * Math.cos((l.options.xLabelAngle * Math.PI) / 180)), c.transform("t" + i + ",0...")),
                  (d = c.getBBox()),
    ...
    (b.Bar = (function(c) {
      ...
      return (
          ...
          for (
            ...
            (h = this.data[this.data.length - 1 - a]),
              ...
              0 !== this.options.xLabelAngle &&
                ((e = -0.5 * i.width * Math.cos((this.options.xLabelAngle * Math.PI) / 180)), b.transform("t" + e + ",0...")),
        ...
        (d.prototype.hoverContentForRow = function(a) {
          var b, c, d, e, f, g, h, i;
          for (
            d = this.data[a], b = "<div class='morris-hover-row-label'>" + d.label + "</div>", i = d.y, c = g = 0, h = i.length;
            h > g;
            c = ++g
          )
            (f = i[c]),
      ...
      return (
        ...
        (b.prototype.select = function() {
          return this.selected
            ? void 0
            : (this.seg.animate({ path: this.selectedPath }, 150, "<>"), this.arc.animate({ opacity: 1 }, 150, "<>"), (this.selected = !0));
        }),
        (b.prototype.deselect = function() {
          return this.selected
            ? (this.seg.animate({ path: this.path }, 150, "<>"), this.arc.animate({ opacity: 0 }, 150, "<>"), (this.selected = !1))
            : void 0;
        }),
        b
      );
