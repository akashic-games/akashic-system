      ...
      q = function(d, f) {
        ...
        for (h = f.length; l < h; l++)
          if (((c = f[l]), b.isArray(c))) q(d, c);
            ...
            e &&
              ((i = b("<li>", { class: s.sPageButton + " " + g, id: 0 === r && "string" === typeof c ? a.sTableId + "_" + c : null })
                .append(
                  b("<a>", { href: "#", "aria-controls": a.sTableId, "aria-label": t[c], "data-dt-idx": p, tabindex: a.iTabIndex }).html(e)
                )
                .appendTo(d)),
