      ...
      if (item) {
        ...
        $.each(plot.getData(), function(i, series) {
          ...
          if (distToLine < closestTrace.distance) {
            var closestIndex =
              lineDistance(pointPrev.x, pointPrev.y, pos.x, pos.y) < lineDistance(pos.x, pos.y, pointNext.x, pointNext.y)
                ? xBeforeIndex
                : xAfterIndex;
        ...
        if (closestTrace.distance < maxDistance + 1) plot.showTooltip(closestTrace.item, ttPos);
