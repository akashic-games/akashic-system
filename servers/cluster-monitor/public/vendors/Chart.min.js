  ...
  })(
    {
          ...
          (o.prototype = {
            ...
            mix: function(t, e) {
              var a = this,
                ...
                s = 1 - l;
              return this.rgb(l * a.red() + s * i.red(), l * a.green() + s * i.green(), l * a.blue() + s * i.blue()).alpha(
                a.alpha() * n + i.alpha() * (1 - n)
              );
            },
            toJSON: function() {
              return this.rgb();
            ...
            (o.prototype.setSpace = function(t, e) {
              ...
              return void 0 === a
                ? this.getValues(t)
                : ("number" == typeof a && (a = Array.prototype.slice.call(e)), this.setValues(t, a), this);
            }),
      ...
      4: [
        function(t, e, a) {
          ...
          function f(t) {
            ...
            return 0 === o
              ? [0, 0, 0]
              : ((o *= 2), (n *= 1 >= o ? o : 2 - o), (a = (o + n) / 2), (e = (2 * n) / (o + n)), [i, 100 * e, 100 * a]);
          }
          function p(t) {
            return o(h(t));
          }
          ...
          function B(t) {
            ...
            return (
              ...
              (e = 0.008856 >= e / 95.047 ? (e = (95.047 * (r / 500 + n - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + n, 3)),
              (i = 0.008859 >= i / 108.883 ? (i = (108.883 * (n - l / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(n - l / 200, 3)),
              [e, a, i]
            );
          }
          function W(t) {
        ...
        function(t, e, a) {
          ...
          e.exports = function(t) {
            ...
            (t.defaults.bar = {
              hover: { mode: "label" },
              scales: {
                xAxes: [{ type: "category", categoryPercentage: 0.8, barPercentage: 0.9, gridLines: { offsetGridLines: !0 } }],
                yAxes: [{ type: "linear" }]
              }
            }),
              (t.controllers.bar = t.DatasetController.extend({
                ...
                calculateBarX: function(t, e) {
                  ...
                  return (
                    ...
                    n.options.stacked
                      ...
                      : l + r.barWidth / 2 + r.categorySpacing + r.barWidth * o + r.barSpacing / 2 + r.barSpacing * o
                  );
                },
                ...
                setHoverStyle: function(t) {
                  ...
                  (o.backgroundColor = n.hoverBackgroundColor
                    ...
                    : e.getValueAtIndexOrDefault(a.hoverBackgroundColor, i, e.getHoverColor(o.backgroundColor))),
                    (o.borderColor = n.hoverBorderColor
                      ? n.hoverBorderColor
                      : e.getValueAtIndexOrDefault(a.hoverBorderColor, i, e.getHoverColor(o.borderColor))),
                    ...
                    title: function(t, e) {
                      ...
                      return (
                        t.length > 0 &&
                          (t[0].yLabel
                            ? (a = t[0].yLabel)
                            : e.labels.length > 0 && t[0].index < e.labels.length && (a = e.labels[t[0].index])),
                        a
                      );
                    },
                    label: function(t, e) {
                    ...
                    inRange: function(t, e) {
                      ...
                      return (
                        a &&
                          (i =
                            a.x < a.base
                              ? e >= a.y - a.height / 2 && e <= a.y + a.height / 2 && t >= a.x && t <= a.base
                              : e >= a.y - a.height / 2 && e <= a.y + a.height / 2 && t >= a.base && t <= a.x),
                        i
                      );
                    }
                  }),
                ...
                calculateBarY: function(t, e) {
                  ...
                  return (
                    ...
                    n.options.stacked
                      ...
                      : l + r.barHeight / 2 + r.categorySpacing + r.barHeight * o + r.barSpacing / 2 + r.barSpacing * o
                  );
                }
              }));
          };
              ...
              (t.controllers.bubble = t.DatasetController.extend({
                ...
                updateElement: function(a, i, n) {
                  ...
                  e.extend(a, {
                    ...
                    _index: i,
                    _model: {
                      x: n ? l.getPixelForDecimal(0.5) : l.getPixelForValue(c, i, f, o.chart.isCombo),
                ...
                setHoverStyle: function(a) {
                  ...
                  l.radius = r.hoverRadius
                    ? r.hoverRadius
                    : e.getValueAtIndexOrDefault(n.hoverRadius, o, i.chart.options.elements.point.hoverRadius) + i.getRadius(n.data[o]);
                },
              ...
              (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                ...
                update: function(t) {
                  ...
                  if (f < 2 * Math.PI) {
                    ...
                    var p = g + f,
                      ...
                      M = { width: 0.5 * (C.x - w.x), height: 0.5 * (C.y - w.y) };
                    (d = Math.min(l / M.width, s / M.height)), (u = { x: (C.x + w.x) * -0.5, y: (C.y + w.y) * -0.5 });
                  }
                ...
                updateElement: function(t, a, i) {
                  ...
                  this.removeHoverStyle(t),
                    (i && s.animateRotate) ||
                      (0 === a ? (v.startAngle = l.rotation) : (v.startAngle = n.getMeta().data[a - 1]._model.endAngle),
              ...
              (t.controllers.line = t.DatasetController.extend({
                ...
                addElementAndReset: function(a) {
                  ...
                  t.DatasetController.prototype.addElementAndReset.call(i, a),
                    e(i.getDataset(), n) && 0 !== o.dataset._model.tension && i.updateBezierControlPoints();
                },
                update: function(t) {
                  var i,
                    n,
                  ...
                  if (u.options.stacked) {
                    for (n = 0; a > n; n++)
                      (o = s.data.datasets[n]),
                        ...
                        "line" === r.type && s.isDatasetVisible(n) && (o.data[e] < 0 ? (h += o.data[e] || 0) : (c += o.data[e] || 0));
                ...
                updateBezierControlPoints: function() {
                  ...
                  for (t = 0, e = l.length; e > t; ++t)
                    (i = l[t]),
                      (n = i._model),
                      (o = a.splineCurve(a.previousItem(l, t)._model, n, a.nextItem(l, t)._model, r.dataset._model.tension)),
                ...
                setHoverStyle: function(t) {
                  var e = this.chart.data.datasets[t._datasetIndex],
                    ...
                    o = t._model;
                  (o.radius =
                    n.hoverRadius || a.getValueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                    (o.backgroundColor =
                      n.hoverBackgroundColor ||
                      a.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, i, a.getHoverColor(o.backgroundColor))),
                    (o.borderColor =
                      n.hoverBorderColor || a.getValueAtIndexOrDefault(e.pointHoverBorderColor, i, a.getHoverColor(o.borderColor))),
      ...
      20: [
        function(t, e, a) {
          ...
          e.exports = function(t) {
            var e = t.helpers;
            (t.defaults.radar = { scale: { type: "radialLinear" }, elements: { line: { tension: 0 } } }),
              (t.controllers.radar = t.DatasetController.extend({
                ...
                setHoverStyle: function(t) {
                  ...
                  (o.radius = i.hoverRadius
                    ? i.hoverRadius
                    : e.getValueAtIndexOrDefault(a.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius)),
                    (o.backgroundColor = i.hoverBackgroundColor
                      ? i.hoverBackgroundColor
                      : e.getValueAtIndexOrDefault(a.pointHoverBackgroundColor, n, e.getHoverColor(o.backgroundColor))),
                    (o.borderColor = i.hoverBorderColor
                      ? i.hoverBorderColor
                      : e.getValueAtIndexOrDefault(a.pointHoverBorderColor, n, e.getHoverColor(o.borderColor))),
                ...
                startDigest: function() {
                  ...
                  for (var i = 0; i < t.animations.length; )
                    null === t.animations[i].animationObject.currentStep && (t.animations[i].animationObject.currentStep = 0),
                      ...
                      t.animations[i].animationObject.currentStep > t.animations[i].animationObject.numSteps &&
                        (t.animations[i].animationObject.currentStep = t.animations[i].animationObject.numSteps),
                      ...
                      t.animations[i].animationObject.onAnimationProgress &&
                        ...
                        t.animations[i].animationObject.onAnimationProgress.call(t.animations[i].chartInstance, t.animations[i]),
                      t.animations[i].animationObject.currentStep === t.animations[i].animationObject.numSteps
                        ? (t.animations[i].animationObject.onAnimationComplete &&
                            t.animations[i].animationObject.onAnimationComplete.call &&
                            t.animations[i].animationObject.onAnimationComplete.call(t.animations[i].chartInstance, t.animations[i]),
              ...
              e.extend(t.Controller.prototype, {
                ...
                buildScales: function() {
                  ...
                  i.scales &&
                    ...
                    i.scale && o.push({ options: i.scale, dtype: "radialLinear", isDefault: !0 }),
                      ...
                      function(e, o) {
                        ...
                        r.type || (r.type = e.type || a.config.type),
                          ...
                          r.controller
                            ...
                            : ((r.controller = new t.controllers[r.type](a, o)), n.push(r.controller));
                      },
                      a
                    ),
                    i.length > 1)
                      ...
                      if (a.data.datasets)
                        for (var t = 0; t < a.data.datasets.length; t++) {
                          ...
                          if (a.isDatasetVisible(t))
                            for (var n = 0; n < e.data.length; n++) if (e.data[n].inRange(i.x, i.y)) return e.data[n];
                        }
                    }.call(a);
                  return o
                    ? (e.each(
                ...
                destroy: function() {
                  ...
                  (i.width = a.chart.width),
                    ...
                    void 0 !== a.chart.originalDevicePixelRatio &&
                      a.chart.ctx.scale(1 / a.chart.originalDevicePixelRatio, 1 / a.chart.originalDevicePixelRatio),
                ...
                initToolTip: function() {
                  var e = this;
                  e.tooltip = new t.Tooltip({ _chart: e.chart, _chartInstance: e, _data: e.data, _options: e.options.tooltips }, e);
                },
                bindEvents: function() {
                  var t = this;
                ...
                eventHandler: function(t) {
                  ...
                  return (
                    ...
                    "mouseout" === t.type
                      ...
                      : ((a.active = a.getElementsAtEventForMode(t, o.mode)), (a.tooltipActive = a.getElementsAtEventForMode(t, r.mode))),
                    o.onHover && o.onHover.call(a, a.active),
                    ("mouseup" === t.type || "click" === t.type) &&
                      (n.onClick && n.onClick.call(a, t, a.active), a.legend && a.legend.handleEvent && a.legend.handleEvent(t)),
                    a.lastActive.length && a.updateHoverStyle(a.lastActive, o.mode, !1),
                    a.active.length && o.mode && a.updateHoverStyle(a.active, o.mode, !0),
                    (r.enabled || r.custom) && (i.initialize(), (i._active = a.tooltipActive), i.update(!0)),
                    i.pivot(),
                    a.animating ||
                      (e.arrayEquals(a.active, a.lastActive) && e.arrayEquals(a.tooltipActive, a.lastTooltipActive)) ||
                      (a.stop(), (r.enabled || r.custom) && i.update(!0), a.render(o.animationDuration, !0)),
              ...
              e.extend(t.DatasetController.prototype, {
                ...
                removeHoverStyle: function(t, a) {
                  var i = this.chart.data.datasets[t._datasetIndex],
                    ...
                    l = (e.color, t._model);
                  (l.backgroundColor = o.backgroundColor ? o.backgroundColor : r(i.backgroundColor, n, a.backgroundColor)),
                    (l.borderColor = o.borderColor ? o.borderColor : r(i.borderColor, n, a.borderColor)),
                    (l.borderWidth = o.borderWidth ? o.borderWidth : r(i.borderWidth, n, a.borderWidth));
                },
                setHoverStyle: function(t) {
                  var a = this.chart.data.datasets[t._datasetIndex],
                    i = t._index,
                  ...
                  (l.backgroundColor = n.hoverBackgroundColor
                    ...
                    (l.borderColor = n.hoverBorderColor ? n.hoverBorderColor : o(a.hoverBorderColor, i, r(l.borderColor))),
                    (l.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : o(a.hoverBorderWidth, i, l.borderWidth));
                }
              }),
          ...
          e.exports = function(t) {
            ...
            (o.each = function(t, e, a, i) {
                  ...
                  o.each(Array.prototype.slice.call(arguments, 1), function(e) {
                    o.each(e, function(e, i) {
                      if ("scales" === i) a[i] = o.scaleMerge(a.hasOwnProperty(i) ? a[i] : {}, e);
                        ...
                        a[i] = o.configMerge(a.hasOwnProperty(i) ? a[i] : {}, t.scaleService.getScaleDefaults(e.type), e);
                      else if (a.hasOwnProperty(i) && o.isArray(a[i]) && o.isArray(e)) {
                        var n = a[i];
                        o.each(e, function(t, e) {
                          e < n.length
                            ? "object" == typeof n[e] && null !== n[e] && "object" == typeof t && null !== t
                              ? (n[e] = o.configMerge(n[e], t))
                              : (n[e] = t)
                            : n.push(t);
                        });
                      } else
                        a.hasOwnProperty(i) && "object" == typeof a[i] && null !== a[i] && "object" == typeof e
                ...
                return (
                  o.each(a, function(e, a) {
                    "xAxes" === a || "yAxes" === a
                      ...
                      : i.hasOwnProperty(a) && "object" == typeof i[a] && null !== i[a] && "object" == typeof e
              ...
              (o.niceNum = function(t, e) {
                var a,
                  ...
                  n = t / Math.pow(10, i);
                return (
                  (a = e ? (1.5 > n ? 1 : 3 > n ? 2 : 7 > n ? 5 : 10) : 1 >= n ? 1 : 2 >= n ? 2 : 5 >= n ? 5 : 10), a * Math.pow(10, i)
                );
              });
            var r = (o.easingEffects = {
              ...
              easeInElastic: function(t) {
                ...
                return 0 === t
                  ...
                  ? 1
                  : (a || (a = 0.3),
                    i < Math.abs(1) ? ((i = 1), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(1 / i)),
              ...
              easeInOutElastic: function(t) {
                ...
                return 0 === t
                  ...
                  : (a || (a = 1 * (0.3 * 1.5)),
                    i < Math.abs(1) ? ((i = 1), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(1 / i)),
                    1 > t
                      ? -0.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a))
                      : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a) * 0.5 + 1);
              },
            ...
            (o.requestAnimFrame = (function() {
              ...
              (o.retinaScale = function(t) {
                ...
                1 !== o &&
                  ((a.height = n * o), (a.width = i * o), e.scale(o, o), (t.originalDevicePixelRatio = t.originalDevicePixelRatio || o)),
                  (a.style.width = i + "px"),
                  (a.style.height = n + "px");
              }),
              (o.clear = function(t) {
          ...
          e.exports = function() {
            var t = function(e, a) {
              ...
              return (
                ...
                (i.width = e.canvas.width || parseInt(n.getStyle(e.canvas, "width"), 10) || n.getMaximumWidth(e.canvas)),
                (i.height = e.canvas.height || parseInt(n.getStyle(e.canvas, "height"), 10) || n.getMaximumHeight(e.canvas)),
                (i.aspectRatio = i.width / i.height),
                (isNaN(i.aspectRatio) || isFinite(i.aspectRatio) === !1) && (i.aspectRatio = void 0 !== a.aspectRatio ? a.aspectRatio : 2),
            ...
            t.layoutService = {
              ...
              update: function(t, a, i) {
                function n(t) {
                  var e,
                    a = t.isHorizontal();
                  a ? ((e = t.update(t.options.fullWidth ? p : k, y)), (S -= e.height)) : ((e = t.update(x, v)), (k -= e.width)),
                ...
                function l(t) {
                  t.isHorizontal()
                    ? ((t.left = t.options.fullWidth ? s : C),
                      ...
                      (t.bottom = P + t.height),
                      (P = t.bottom))
                    : ((t.left = T), (t.right = T + t.width), (t.top = D), (t.bottom = D + S), (T = t.right));
                }
                if (t) {
                  var s = 0,
                    d = 0,
                  ...
                  e.each(u.concat(h), l),
                    ...
                    e.each(c, l),
                    e.each(f, l),
                    (t.chartArea = { left: C, top: D, right: C + k, bottom: D + S }),
                    e.each(g, function(e) {
                    ...
                    if (((r.font = h), p)) {
                      ...
                      (r.textAlign = "left"),
                        ...
                        e.each(a.legendItems, function(t, e) {
                          ...
                          m[m.length - 1] + i + n.padding >= a.width && ((b += d + n.padding), (m[m.length] = a.left)),
                ...
                draw: function() {
                  ...
                  if (i.display) {
                    ...
                    var b = n.boxWidth,
                      ...
                      k = a.isHorizontal();
                    d = k ? { x: a.left + (l - s[0]) / 2, y: a.top + n.padding, line: 0 } : { x: a.left + n.padding, y: a.top, line: 0 };
                    var S = f + n.padding;
                    e.each(a.legendItems, function(t, e) {
                      var i = u.measureText(t.text).width,
                        ...
                        c = d.y;
                      k
                        ? r + o >= l && ((c = d.y += f + n.padding), d.line++, (r = d.x = a.left + (l - s[d.line]) / 2))
                        : c + S > a.bottom && ((r = d.x = r + a.columnWidths[d.line] + n.padding), (c = d.y = a.top), d.line++),
                        x(r, c, t),
                        (v[e].left = r),
                        (v[e].top = c),
                        y(r, c, t, i),
            ...
            (t.defaults.scale = {
              ...
              (t.Scale = t.Element.extend({
                ...
                fit: function() {
                  ...
                  if (
                    (d ? (i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth) : (i.width = s ? b : 0),
                  ...
                  if (n.display) {
                    ...
                    if (g) {
                      if (
                        ((o = !1),
                        h && (I /= 2),
                        (I + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) &&
                          (o = 1 + Math.floor(((I + d.autoSkipPadding) * i.ticks.length) / (i.width - (i.paddingLeft + i.paddingRight)))),
                        r && i.ticks.length > r)
                      )
                    ...
                    if (
                        ...
                        if (void 0 !== t && null !== t) {
                          ...
                          if ((!s || l) && void 0 !== t && null !== t) {
                            ...
                            r === ("undefined" != typeof i.zeroLineIndex ? i.zeroLineIndex : 0)
                              ...
                              : ((c = e.getValueAtIndexOrDefault(u.lineWidth, r)), (f = e.getValueAtIndexOrDefault(u.color, r)));
                            var p,
                              m,
                              b,
                              v,
                            ...
                            if (g) {
                              ...
                              (C = i.getPixelForTick(r, u.offsetGridLines) + d.labelOffset),
                                (M = h ? i.top + 12 : "top" === n.position ? i.bottom - y : i.top + y),
                                (p = b = x = S = V),
                                (m = _),
                                (v = R),
                                (k = a.top),
                      ...
                      e.each(F, function(t) {
                        if (
                          ...
                          var a = t.label;
                          if (e.isArray(a)) for (var i = 0, n = 0; i < a.length; ++i) l.fillText("" + a[i], 0, n), (n += 1.5 * m);
          ...
          e.exports = function(t) {
            ...
            function i(t) {
              var e = t._xScale,
                ...
                i = t._index,
                n = t._datasetIndex;
              return { xLabel: e ? e.getLabelForIndex(i, n) : "", yLabel: a ? a.getLabelForIndex(i, n) : "", index: i, datasetIndex: n };
            }
            var n = t.helpers;
              ...
              (t.Tooltip = t.Element.extend({
                ...
                determineAlignment: function(t) {
                  ...
                  "center" === a.yAlign
                    ...
                    o(a.x)
                      ? ((a.xAlign = "left"), l(a.x) && ((a.xAlign = "center"), (a.yAlign = d(a.y))))
                      : r(a.x) && ((a.xAlign = "right"), s(a.x) && ((a.xAlign = "center"), (a.yAlign = d(a.y))));
                },
                getBackgroundPoint: function(t, e) {
                  ...
                  return (
                    ...
                    "top" === l ? (a.y += s) : "bottom" === l ? (a.y -= e.height + s) : (a.y -= e.height / 2),
                    "center" === l
                      ? "left" === r
                        ? (a.x += s)
                        : "right" === r && (a.x -= s)
                ...
                drawCaret: function(t, e, a, i) {
                  var o,
                    ...
                    y = e.height;
                  "center" === m
                    ? ("left" === p ? ((o = b), (r = o - f), (l = o)) : ((o = b + x), (r = o + f), (l = o)),
                      (d = v + y / 2),
                      (s = d - f),
                      (u = d + f))
                    : ("left" === p
                        ...
                        ? ((o = b + x - g), (r = o - f), (l = r - f))
                        : ((r = b + x / 2), (o = r - f), (l = r + f)),
                      "top" === m ? ((s = v), (d = s - f), (u = s)) : ((s = v + y), (d = s + f), (u = s)));
                ...
                drawFooter: function(t, e, a, i) {
                  ...
                  if (o.length) {
                    ...
                    (a.fillStyle = r.alpha(i * r.alpha()).rgbString()),
                      (a.font = n.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily)),
                      n.each(o, function(i) {
            ...
            (i.elements.arc = { backgroundColor: i.defaultColor, borderColor: "#fff", borderWidth: 2 }),
              (t.elements.Arc = t.Element.extend({
                ...
                inRange: function(t, e) {
                  ...
                  if (i) {
                    for (
                      var n = a.getAngleFromPoint(i, { x: t, y: e }), o = n.angle, r = n.distance, l = i.startAngle, s = i.endAngle;
                      l > s;
                    ...
                    i._children.length > 0 &&
                      ...
                      e.each(
                        ...
                        function(t, a) {
                          ...
                          0 === a
                            ? (i._loop ? o.moveTo(n.scaleZero.x, n.scaleZero.y) : o.moveTo(t._view.x, n.scaleZero),
                              t._view.skip ? i._loop || o.moveTo(l._view.x, i._view.scaleZero) : o.lineTo(t._view.x, t._view.y))
                            : i.lineToNextPoint(
                                r,
                                t,
                                l,
                                function(t, e, a) {
                                  i._loop
                                    ...
                                    : (o.lineTo(t._view.x, i._view.scaleZero), o.moveTo(a._view.x, i._view.scaleZero));
                                },
                                function(t, e) {
              ...
              (t.elements.Point = t.Element.extend({
                ...
                draw: function() {
                  ...
                  if (!d.skip) {
                    if (
                      "object" == typeof c &&
                      ((t = c.toString()), "[object HTMLImageElement]" === t || "[object HTMLCanvasElement]" === t)
                    )
                      return void u.drawImage(c, f - c.width / 2, g - c.height / 2);
                    if (!(isNaN(h) || 0 >= h)) {
                      switch (
                        ((u.strokeStyle = d.borderColor || i),
                        (u.lineWidth = e.getValueOrDefault(d.borderWidth, a.elements.point.borderWidth)),
              ...
              i = t.Scale.extend({
                determineDataLimits: function() {
                  ...
                  void 0 !== t.options.ticks.min &&
                    ((a = e.indexOf(t.chart.data.labels, t.options.ticks.min)), (t.minIndex = -1 !== a ? a : t.minIndex)),
                    void 0 !== t.options.ticks.max &&
                      ((a = e.indexOf(t.chart.data.labels, t.options.ticks.max)), (t.maxIndex = -1 !== a ? a : t.maxIndex)),
              ...
              i = t.LinearScaleBase.extend({
                      ...
                      n.isDatasetVisible(r) &&
                        ...
                        e.each(o.data, function(t, e) {
                          ...
                          isNaN(n) ||
                            ...
                            ((c[e] = c[e] || 0),
                            (h[e] = h[e] || 0),
                            i.relativePoints ? (c[e] = 100) : 0 > n ? ((u = !0), (h[e] += n)) : ((d = !0), (c[e] += n)));
                        });
                    }),
                      e.each(s, function(t) {
                ...
                getPixelForValue: function(t, e, a, i) {
                  ...
                  return r.isHorizontal()
                    ? ((o = r.width - (l + r.paddingRight)), (n = r.left + (o / c) * (u - d)), Math.round(n + l))
                    : ((o = r.height - (r.paddingTop + s)), (n = r.bottom - s - (o / c) * (u - d)), Math.round(n));
                },
                getValueForPixel: function(t) {
                  var e = this,
                    a = e.isHorizontal(),
            ...
            t.LinearScaleBase = t.Scale.extend({
              ...
              buildTicks: function() {
                ...
                o.push(void 0 !== i.max ? i.max : c),
                  ...
                  (t.max = e.max(o)),
                  (t.min = e.min(o)),
                  i.reverse ? (o.reverse(), (t.start = t.max), (t.end = t.min)) : ((t.start = t.min), (t.end = t.max));
              },
              convertTicksToLabels: function() {
                var e = this;
              ...
              i = t.Scale.extend({
                determineDataLimits: function() {
                  ...
                  (a.min = s(n.min, a.min)),
                    ...
                    a.min === a.max &&
                      (0 !== a.min && null !== a.min
                        ? ((a.min = Math.pow(10, Math.floor(e.log10(a.min)) - 1)), (a.max = Math.pow(10, Math.floor(e.log10(a.max)) + 1)))
                        : ((a.min = 1), (a.max = 10)));
                },
                buildTicks: function() {
                  for (
                ...
                getPixelForValue: function(t, a, i, n) {
                  ...
                  return (
                    l.isHorizontal()
                      ? 0 === d
                        ? (r = l.left + f)
                        : ((o = l.width - (f + l.paddingRight)), (r = l.left + (o / u) * (e.log10(d) - e.log10(s))), (r += f))
                      : 0 === d
                      ? (r = l.top + c)
                      : ((o = l.height - (c + h)), (r = l.bottom - h - (o / u) * (e.log10(d) - e.log10(s)))),
                    r
                  );
                },
                getValueForPixel: function(t) {
                  ...
                  for (this.ctx.font = v, i = 0; i < this.getValueCount(); i++)
                    (t = this.getPointPosition(i, x)),
                      ...
                      0 === i || i === this.getValueCount() / 2
                        ? ((o = n / 2), t.x + o > y && ((y = t.x + o), (r = i)), t.x - o < k && ((k = t.x - o), (s = i)))
                    ...
                    if (
                      ...
                      for (
                        ...
                        0 === x
                          ...
                          ? (d.textAlign = "left")
                          : (d.textAlign = "right"),
                          I ? (d.textBaseline = "middle") : A ? (d.textBaseline = "bottom") : (d.textBaseline = "top"),
              ...
              var e = t.helpers,
                ...
                o = t.Scale.extend({
                            ...
                            ? e.each(
                                ...
                                function(e, a) {
                                  ...
                                  n.isValid() &&
                                    ...
                                    r.push(n),
                                    l &&
                                      ((t.firstTick = null !== t.firstTick ? i.min(t.firstTick, n) : n),
                  ...
                  buildTicks: function(i) {
                    ...
                    if (((n.ctx.font = s), (n.ticks = []), (n.unitScale = 1), (n.scaleSizeInUnits = 0), n.options.time.unit))
                  ...
                  getLabelForIndex: function(t, e) {
                    ...
                    return (
                      "object" == typeof a.chart.data.datasets[e].data[0] && (i = a.getRightValue(a.chart.data.datasets[e].data[t])),
