      ...
      (i = [r(2)]),
        (n = function(t) {
          ...
          function h(t, e, r, i, n, a, s, o, h) {
            if (!(0 > h || l(t, e, r, i, n, a, s, o) < h)) {
              ...
              for (p = l(t, e, r, i, n, a, s, o, f); H(p - h) > d; )
                (c /= 2), (f += (h > p ? 1 : -1) * c), (p = l(t, e, r, i, n, a, s, o, f));
              return f;
            }
          }
          ...
          function p(t, r, i) {
            ...
            for (x = 0; c + 1 > x; x++) (v = e.findDotsAtSegment.apply(e, r.concat(x / c))), p.push({ x: v.x, y: v.y, t: x / c });
            for (x = 0; h > x; x++)
              for (var y = 0; c > y; y++) {
                var m = f[x],
                  b = f[x + 1],
                ...
                if (C) {
                  ...
                  S >= 0 && 1.001 >= S && T >= 0 && 1.001 >= T && (i ? g++ : g.push({ x: C.x, y: C.y, t1: G(S, 1), t2: G(T, 1) }));
                }
              }
            return g;
          }
            ...
            if (l) {
              if (h) (h.initstatus = a), (h.start = new Date() - h.ms * a);
                  ...
                  if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C)))
                    switch (((v[C] = i.attr(C)), null == v[C] && (v[C] = ft[C]), (m[C] = l[C]), pt[C])) {
                      ...
                      case "csv":
                        ...
                        break;
                      default:
                        for (I = [][P](l[C]), D = [][P](v[C]), b[C] = [], w = i.paper.customAttributes[C].length; w--; )
                          b[C][w] = ((I[w] || 0) - (D[w] || 0)) / x;
                    }
                var V = l.easing,
                ...
                if (
                  ...
                  Ee.push(_),
                  a && !h && !u && ((_.stop = !0), (_.start = new Date() - x * a), 1 == Ee.length))
                )
                  return Me();
          ...
          var w,
            ...
            E = { was: Object.prototype[T].call(A.win, "Raphael"), is: A.win.Raphael },
            N = function() {
            ...
            At = function(t, e, r, i) {
              return (
                null == i && (i = r), [["M", t, e], ["m", 0, -i], ["a", r, i, 0, 1, 1, 0, 2 * i], ["a", r, i, 0, 1, 1, 0, -2 * i], ["z"]]
              );
            },
            Et = (e._getPath = {
              path: function(t) {
          ...
          if (
            ((e._g = A),
            (e.type =
              A.win.SVGAngle || A.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1")
                ? "SVG"
                : "VML"),
            "VML" == e.type)
          ) {
          ...
          var Pt = function(t) {
            ...
            jt = function(t, r, i) {
              if (
                (null == r && e.is(t, "object") && "r" in t && "g" in t && "b" in t && ((i = t.b), (r = t.g), (t = t.r)),
                null == r && e.is(t, Z))
              ) {
                var n = e.getRGB(t);
                (t = n.r), (r = n.g), (i = n.b);
          ...
          (e.getRGB = n(function(t) {
            ...
            return u
              ? (u[2] && ((s = ut(u[2].substring(5), 16)), (n = ut(u[2].substring(3, 5), 16)), (i = ut(u[2].substring(1, 3), 16))),
                u[3] &&
                  ((s = ut((l = u[3].charAt(3)) + l, 16)), (n = ut((l = u[3].charAt(2)) + l, 16)), (i = ut((l = u[3].charAt(1)) + l, 16))),
                u[4] &&
                  ((h = u[4][q](gt)),
                  (i = ht(h[0])),
                  "%" == h[0].slice(-1) && (i *= 2.55),
            ...
            (e.getColor = function(t) {
              ...
              return (
                (e.h += 0.075), e.h > 1 && ((e.h = 0), (e.s -= 0.2), e.s <= 0 && (this.getColor.start = { h: 0, s: 1, b: e.b })), r.hex
              );
            }),
          ...
          var Ot = (e.pathBBox = function(t) {
            ...
            Zt = n(function(t, e, r, i, n, a, s, o) {
              ...
              return (
                H(c) > "1e12" && (c = 0.5),
                H(f) > "1e12" && (f = 0.5),
                c > 0 && 1 > c && ((g = $t(t, e, r, i, n, a, s, o, c)), d.push(g.x), p.push(g.y)),
                f > 0 && 1 > f && ((g = $t(t, e, r, i, n, a, s, o, f)), d.push(g.x), p.push(g.y)),
                (l = a - 2 * i + e - (o - 2 * a + i)),
                (h = 2 * (i - e) - 2 * (a - i)),
                (u = e - i),
                (c = (-h + Y.sqrt(h * h - 4 * l * u)) / 2 / l),
                ...
                for (var c = 0, f = i.length; f > c; c++) {
                  ...
                  "t" == x && 3 == d
                    ...
                    ? 2 == d
                      ...
                      : 4 == d &&
                        (v ? ((_ = y.x(p[2], p[3])), (w = y.y(p[2], p[3])), u.rotate(p[1], _, w)) : u.rotate(p[1], p[2], p[3]), (n += p[1]))
                    : "s" == x
                    ? 2 == d || 3 == d
                      ? ((k = k || t.getBBox(1)),
                        ...
                        (l *= p[d - 1]))
                      : 5 == d &&
                        (v ? ((_ = y.x(p[3], p[4])), (w = y.y(p[3], p[4])), u.scale(p[1], p[2], _, w)) : u.scale(p[1], p[2], p[3], p[4]),
                        (o *= p[1]),
                        (l *= p[2]))
            ...
            le = (e._equaliseTransform = function(t, r) {
              ...
              for (var i = W(t.length, r.length), n = [], a = [], s = 0, o, l, h, u; i > s; s++) {
                if (
                  ...
                  return;
                for (n[s] = [], a[s] = [], o = 0, l = W(h.length, u.length); l > o; o++)
          ...
          (e._getContainer = function(t, r, i, n) {
            var a;
            return (
              (a = null != n || e.is(t, "object") ? t : A.doc.getElementById(t)),
              null != a
                ? a.tagName
                  ? null == r
            ...
            (function(t) {
              ...
              (t.add = function(t, e, r, i, n, a) {
                var s = [[], [], []],
                  ...
                  c,
                  f;
                for (t && t instanceof g && (l = [[t.a, t.c, t.e], [t.b, t.d, t.f], [0, 0, 1]]), h = 0; 3 > h; h++)
                  for (u = 0; 3 > u; u++) {
                ...
                (t.split = function() {
                  ...
                  var a = -n[0][1],
                    s = n[1][1];
                  return (
                    0 > s ? ((t.rotate = e.deg(Y.acos(s))), 0 > a && (t.rotate = 360 - t.rotate)) : (t.rotate = e.deg(Y.asin(a))),
                  ...
                  ? function(t, e, r, i) {
                      var n = function(t) {
                        ...
                        var e = A.doc.documentElement.scrollTop || A.doc.body.scrollTop,
                          ...
                          s = t.clientY + e;
                        return (
                          (t.preventDefault = t.preventDefault || he), (t.stopPropagation = t.stopPropagation || ce), r.call(i, t, a, s)
                        );
                      };
              ...
              (e[t] = ye[t] = function(r, i) {
                return (
                  e.is(r, "function") &&
                    ...
                    this.events.push({ name: t, f: r, unbind: de(this.shape || this.node || A.doc, t, r, i || this) })),
                  this
                );
              }),
          ...
          (M.getElementByPoint = function(t, e) {
            ...
            (ye.isPointInside = function(t, r) {
              ...
              return (
                this.attr("transform") && this.attr("transform").length && (i = e.transformPath(i, this.attr("transform"))),
            ...
            (ye.getBBox = function(t) {
              ...
              return t
                ? ((!e.dirty && e.bboxwt) ||
                    ((this.realPath = Et[this.type](this)), (e.bboxwt = Ot(this.realPath)), (e.bboxwt.toString = v), (e.dirty = 0)),
                  e.bboxwt)
                        ...
                        if (l[T](y)) {
                          switch (pt[y]) {
                            ...
                            case "colour":
                              d =
                                "rgb(" +
                                [Le(ot(l[y].r + v * s * h[y].r)), Le(ot(l[y].g + v * s * h[y].g)), Le(ot(l[y].b + v * s * h[y].b))].join(
                                  ","
                                ) +
                                ")";
                              break;
                            ...
                            case "transform":
                              if (h[y].real)
                                for (d = [], m = 0, _ = l[y].length; _ > m; m++)
                                  for (d[m] = [l[y][m][0]], w = 1, k = l[y][m].length; k > w; w++)
          ...
          return (
            (Pe.attr = function(t, r) {
              if (t && e.is(t, Q) && e.is(t[0], "object")) for (var i = 0, n = t.length; n > i; i++) this.items[i].attr(t[i]);
              else for (var a = 0, s = this.items.length; s > a; a++) this.items[a].attr(t, r);
              return this;
            }),
            (Pe.clear = function() {
              ...
              if (
                ...
                if (a)
                  for (
                    ...
                    u > h &&
                    ((l = a[h]),
                    l.face["font-weight"] != r || (l.face["font-style"] != i && l.face["font-style"]) || l.face["font-stretch"] != n);
                    h++
                  );
                return l;
              }
            ...
            for (m = 0; b > m; m++)
              if (((l = a[m]), "zIndex" in l))
                if (l.zIndex == h[s]) {
                  ...
                  do if ((s++, (l = g[h[s]]), l && x.push(l.apply(e, n)), f)) break;
                  while (l);
                } else g[l.zIndex] = l;
        ...
        (d._events = p),
          ...
          (d.on = function(t, e) {
            ...
            for (var r = t.split(o), i = p, n = 0, a = r.length; a > n; n++)
              (i = i.n), (i = (i.hasOwnProperty(r[n]) && i[r[n]]) || (i[r[n]] = { n: {} }));
          ...
          if (!t || t.svg) {
            ...
            var x = function(i, n) {
              ...
              v = function(e, n) {
                ...
                if (!y) {
                  ...
                  if (
                    ...
                    (y = x(h + "Gradient", { id: u })),
                      ...
                      x(
                        y,
                        "radial" == h ? { fx: f, fy: p } : { x1: _[0], y1: _[1], x2: _[2], y2: _[3], gradientTransform: e.matrix.invert() }
                      ),
                ...
                return x(d, { fill: m(u), opacity: 1, "fill-opacity": 1 }), (v.fill = c), (v.opacity = 1), (v.fillOpacity = 1), 1;
              },
              y = function() {
              ...
              _ = function(i, n, a) {
                if ("path" == i.type) {
                  ...
                  if (
                    ("open" == v
                      ? ((k += 2), (B += 2), (C += 2), (b = 1), (_ = a ? 4 : 1), (w = { fill: "none", stroke: u.stroke }))
                    ...
                    A
                      ...
                      : ((A = x(x("marker"), { id: T, markerHeight: B, markerWidth: k, orient: "auto", refX: _, refY: B / 2 })),
                        (E = x(x("use"), {
                          "xlink:href": "#" + S,
                    ...
                    switch (((u[d] = g), d)) {
                      ...
                      case "fill":
                        ...
                        if (z.error) {
                          ...
                          delete a.gradient,
                            delete u.gradient,
                            !t.is(u.opacity, "undefined") && t.is(a.opacity, "undefined") && x(l, { opacity: u.opacity }),
                      ...
                      case "stroke":
                        (z = t.getRGB(g)),
                          ...
                          "stroke" == d && z[e]("opacity") && x(l, { "stroke-opacity": z.opacity > 1 ? z.opacity / 100 : z.opacity }),
                          "stroke" == d &&
                            i._.arrows &&
                            ("startString" in i._.arrows && _(i, i._.arrows.startString),
                            "endString" in i._.arrows && _(i, i._.arrows.endString, 1));
                      ...
                      case "fill-opacity":
                        if (u.gradient) {
                          (P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c))),
                            P && ((F = P.getElementsByTagName("stop")), x(F[F.length - 1], { "stop-opacity": g }));
                          break;
                        }
                      default:
              ...
              S = function(i, a) {
                if ("text" == i.type && (a[e]("text") || a[e]("font") || a[e]("font-size") || a[e]("x") || a[e]("y"))) {
                  ...
                  if (a[e]("text")) {
                    ...
                    for (u = o.getElementsByTagName("tspan"), p = 0, d = u.length; d > p; p++)
            ...
            (A.prototype = E),
              ...
              (E.attr = function(r, i) {
                ...
                if (null == i && t.is(r, "string")) {
                  ...
                  for (var s = r.split(h), o = {}, l = 0, c = s.length; c > l; l++)
                    (r = s[l]),
                      r in this.attrs
                        ? (o[r] = this.attrs[r])
              ...
              T = function(n, l) {
                ...
                if (
                  ...
                  if (
                    ...
                    l.fill && (I.on = !0),
                    (null != I.on && "none" != l.fill && null !== l.fill) || (I.on = !1),
                    I.on && l.fill)
                  ) {
                    ...
                    if (q) {
                      ...
                      (I.color = t.getRGB(l.fill).hex),
                        ...
                        t.getRGB(l.fill).error &&
                          ...
                          A(m, l.fill, I) &&
                          ((f.fill = "none"), (f.gradient = l.fill), (I.rotate = !1));
                  }
                  ...
                  if (
                    ...
                    l["stroke-linecap"] &&
                      (O.endcap = "butt" == l["stroke-linecap"] ? "flat" : "square" == l["stroke-linecap"] ? "square" : "round"),
                ...
                if ("text" == m.type) {
                  ...
                  for (
                    var Q = ["x", "y", "text", "font", "font-family", "font-weight", "font-style", "font-size"], J = 0, K = Q.length;
                    K > J;
                    J++
                  )
                    if (Q[J] in l) {
              ...
              A = function(e, a, s) {
                  ...
                  (a = r(a).replace(t._radial_gradient, function(t, e, r) {
                    return (
                      ...
                      e &&
                        ...
                        ((e = i(e)),
                        (r = i(r)),
                        l(e - 0.5, 2) + l(r - 0.5, 2) > 0.25 && (r = n.sqrt(0.25 - l(e - 0.5, 2)) * (2 * (r > 0.5) - 1) + 0.5),
                        (f = e + p + r)),
                      d
                    );
                  })),
                ...
                if (((e = e.shape || e.node), x.length)) {
                  ...
                  (s.colors = v.length ? v.join() : "0% " + s.color),
                    "radial" == c
                      ? ((s.type = "gradientTitle"), (s.focus = "100%"), (s.focussize = "0 0"), (s.focusposition = f), (s.angle = 0))
            ...
            (E.prototype = N),
              ...
              (t._engine.rect = function(e, r, i, n, a, s) {
                var o = t._rectPath(r, i, n, a, s),
                  ...
                  h = l.attrs;
                return (
                  (l.X = h.x = r), (l.Y = h.y = i), (l.W = h.width = n), (l.H = h.height = a), (h.r = s), (h.path = o), (l.type = "rect"), l
                );
              }),
              (t._engine.ellipse = function(t, e, r, i, n) {
                var a = t.path(),
                  s = a.attrs;
                return (
                  (a.X = e - i), (a.Y = r - n), (a.W = 2 * i), (a.H = 2 * n), (a.type = "ellipse"), T(a, { cx: e, cy: r, rx: i, ry: n }), a
                );
              }),
              (t._engine.circle = function(t, e, r, i) {
                var n = t.path(),
              ...
              (t._engine.setViewBox = function(e, r, i, n, a) {
                ...
                var s = this.getSize(),
                  ...
                  u;
                return (
                  a && ((h = l / n), (u = o / i), o > i * h && (e -= (o - i * h) / 2 / h), l > n * u && (r -= (l - n * u) / 2 / u)),
