...
(function(b) {
  ...
  b.extend(!0, g.defaults, {
    dom:
      "<'row uk-grid'<'uk-width-1-2'l><'uk-width-1-2'f>><'row uk-grid dt-merge-grid'<'uk-width-1-1'tr>><'row uk-grid dt-merge-grid'<'uk-width-2-5'i><'uk-width-3-5'p>>",
    renderer: "uikit"
  });
          ...
          if (((e = g[l]), b.isArray(e))) q(c, e);
            ...
            switch (e) {
              ...
              case "next":
                ...
                break;
              case "last":
                f = k.sLast + ' <i class="uk-icon-angle-double-right"></i>';
                d = j < n - 1 ? "" : " uk-disabled disabled";
                break;
              default:
            ...
            f &&
              ((i = b("<li>", { class: s.sPageButton + " " + d, id: 0 === r && "string" === typeof e ? a.sTableId + "_" + e : null })
                .append(
                  b(-1 != d.indexOf("disabled") || -1 != d.indexOf("active") ? "<span>" : "<a>", {
                    href: "#",
                ...
                .appendTo(c)),
              a.oApi._fnBindAction(i, { action: e }, m),
              p++);
          }
      },
      i;
