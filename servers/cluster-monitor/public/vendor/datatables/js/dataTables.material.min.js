...
(function(c) {
  ...
  c.extend(!0, g.defaults, {
    dom:
      "<'mdl-grid'<'mdl-cell mdl-cell--6-col'l><'mdl-cell mdl-cell--6-col'f>><'mdl-grid dt-table'<'mdl-cell mdl-cell--12-col'tr>><'mdl-grid'<'mdl-cell mdl-cell--4-col'i><'mdl-cell mdl-cell--8-col'p>>",
    renderer: "material"
  });
  ...
  g.ext.renderer.pageButton.material = function(a, h, r, s, i, n) {
    var o = new g.Api(a),
          ...
          if (((b = g[m]), c.isArray(b))) q(d, b);
            ...
            f &&
              ((j = c("<button>", {
                ...
                .html(f)
                .appendTo(d)),
              a.oApi._fnBindAction(j, { action: b }, k),
              p++);
          }
      },
      k;
