...
(function(b) {
  ...
  b.extend(!0, e.defaults, {
    dom:
      "<'ui grid'<'row'<'eight wide column'l><'right aligned eight wide column'f>><'row dt-table'<'sixteen wide column'tr>><'row'<'seven wide column'i><'right aligned nine wide column'p>>>",
    renderer: "semanticUI"
  });
    ...
    var n = new e.Api(h),
      ...
      p = function(a, d) {
        var e,
          ...
          q = function(a) {
            a.preventDefault();
            !b(a.currentTarget).hasClass("disabled") && n.page() != a.data.action && n.page(a.data.action).draw("page");
          };
        e = 0;
        for (i = d.length; e < i; e++)
          if (((c = d[e]), b.isArray(c))) p(a, c);
          else {
            g = f = "";
            switch (c) {
              case "ellipsis":
            ...
            f &&
              ((l = b("<" + l + ">", {
                ...
                .html(f)
                .appendTo(a)),
              h.oApi._fnBindAction(l, { action: c }, q),
              o++);
          }
      },
      i;
