...
!(function(a, b) {
  ...
  r.extend({
    ...
    r.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function(
      a,
      b
    ) {
      r.fn[a] = function(a) {
        ...
        select: {
          get: function(a) {
            for (
              ...
              if (
                ((c = d[i]), (c.selected || i === e) && !c.disabled && (!c.parentNode.disabled || !r.nodeName(c.parentNode, "optgroup")))
              ) {
            ...
            ? ((d = f.getBoundingClientRect()),
              d.width || d.height
                ? ((e = f.ownerDocument),
                  (c = Sb(e)),
                  (b = e.documentElement),
                  { top: d.top + c.pageYOffset - b.clientTop, left: d.left + c.pageXOffset - b.clientLeft })
                : d)
            : { top: 0, left: 0 };
      },
      position: function() {
