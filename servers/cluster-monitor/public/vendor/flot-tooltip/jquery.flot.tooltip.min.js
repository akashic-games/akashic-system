  ...
  (c.prototype.init = function(b) {
    ...
    function d(c, d, g) {
      f.clickmode
        ...
        : (e(c, d, g), f.getDomElement().is(":visible") && (a(b.getPlaceholder()).unbind("plothover", e), (f.clickmode = !0)));
    }
    function e(c, d, e) {
        ...
        h = function(a, b, c, d, e, f, h) {
          if (
            ...
            ((h = (function(a, b, c, d, e, f) {
              ...
              var g,
                h = -1 / ((f - d) / (e - c));
              return { x: (g = (e * (a * h - b + d) + c * (a * -h + b - f)) / (h * (e - c) + d - f)), y: h * g - h * a + b };
            })(a, b, c, d, e, f)),
      ...
      if (e) b.showTooltip(e, f.tooltipOptions.snap ? e : d);
        ...
        a.each(b.getData(), function(a, c) {
          ...
          if (o < j.distance) {
            ...
            (j = { distance: o, item: r }), f.tooltipOptions.snap && (k = { pageX: c.xaxis.p2c(q[0]), pageY: c.yaxis.p2c(q[1]) });
          }
        }),
    ...
    b.hooks.bindEvents.push(function(b, g) {
      if (
        ...
        (f.tooltipOptions = f.plotOptions.tooltip),
          f.tooltipOptions.$compat ? ((f.wfunc = "width"), (f.hfunc = "height")) : ((f.wfunc = "innerWidth"), (f.hfunc = "innerHeight"));
        f.getDomElement();
      ...
      (b.setTooltipPosition = function(b) {
        ...
        b.x - a(window).scrollLeft() > a(window)[f.wfunc]() - d && (b.x -= d),
          ...
          isNaN(b.x) ? (f.tipPosition.x = f.tipPosition.xPrev) : ((f.tipPosition.x = b.x), (f.tipPosition.xPrev = b.x)),
          isNaN(b.y) ? (f.tipPosition.y = f.tipPosition.yPrev) : ((f.tipPosition.y = b.y), (f.tipPosition.yPrev = b.y));
      }),
      (b.showTooltip = function(a, c, d) {
        ...
        "" !== g &&
          ...
          e.css({ left: f.tipPosition.x + f.tooltipOptions.shifts.x, top: f.tipPosition.y + f.tooltipOptions.shifts.y }).show(),
    ...
    (c.prototype.stringFormat = function(a, b) {
      ...
      if (
        ("undefined" != typeof b.series.threshold
          ...
          ? ((c = b.series.datapoints.points[2 * b.dataIndex]), (d = b.series.datapoints.points[2 * b.dataIndex + 1]), (e = ""))
          : ((c = b.series.data[b.dataIndex][0]), (d = b.series.data[b.dataIndex][1]), (e = b.series.data[b.dataIndex][2])),
      ...
      if (
        ...
        this.isTimeMode("xaxis", b) &&
          ...
          (a = a.replace(m, this.timestampToDate(c, this.tooltipOptions.xDateFormat, b.series.xaxis.options))),
        this.isTimeMode("yaxis", b) &&
          this.isYDateFormat(b) &&
          (a = a.replace(n, this.timestampToDate(d, this.tooltipOptions.yDateFormat, b.series.yaxis.options))),
